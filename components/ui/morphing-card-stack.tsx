...
export function Component({
  ...
  const [activeIndex, setActiveIndex] = useState(initialCard)
  ...
  return (
    <div className={cn("space-y-4", className)}>
      <div className="flex items-center justify-center gap-1 rounded-lg bg-[#1a1a1a] border border-[#333333] p-1 w-fit mx-auto">
              ...
              return (
                ...
                >
                  <div className="flex items-start gap-3">
                    {card.icon && (
                      <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-[#333333] text-white">
                        {card.icon}
                      </div>
                    )}
                  ...
                  {isTopCard && (
                    <div className="absolute bottom-2 left-0 right-0 text-center">
                      <span className="text-xs text-[#888888]">Swipe to navigate</span>
                    </div>
                  )}
                </motion.div>
              )
          ...
          {cards.map((_, index) => (
            <button
              ...
              className={cn(
                ...
                index === activeIndex ? "w-4 bg-white" : "w-1.5 bg-[#555555] hover:bg-[#666666]",
              )}
